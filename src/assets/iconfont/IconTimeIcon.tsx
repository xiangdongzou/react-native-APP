...
let IconTimeIcon: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconTimeIcon.defaultProps = {
  size: 18,
};

IconTimeIcon = React.memo ? React.memo(IconTimeIcon) : IconTimeIcon;

export default IconTimeIcon;
