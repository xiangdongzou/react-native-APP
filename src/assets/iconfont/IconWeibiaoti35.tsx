...
let IconWeibiaoti35: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconWeibiaoti35.defaultProps = {
  size: 18,
};

IconWeibiaoti35 = React.memo ? React.memo(IconWeibiaoti35) : IconWeibiaoti35;

export default IconWeibiaoti35;
